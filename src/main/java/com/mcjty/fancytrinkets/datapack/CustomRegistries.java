...
public class CustomRegistries {
    ...
    public static final Supplier<IForgeRegistry<TrinketDescription>> TRINKET_REGISTRY = TRINKET_DEFERRED_REGISTER.makeRegistry(TrinketDescription.class, () -> new RegistryBuilder<TrinketDescription>().dataPackRegistry(TrinketDescription.CODEC));
    ...
    public static final Supplier<IForgeRegistry<EffectDescription>> EFFECT_REGISTRY = EFFECT_DEFERRED_REGISTER.makeRegistry(EffectDescription.class, () -> new RegistryBuilder<EffectDescription>().dataPackRegistry(EffectDescription.CODEC));
    ...
    public static final Supplier<IForgeRegistry<BonusTable>> BONUS_TABLE_REGISTRY = BONUS_TABLE_DEFERRED_REGISTER.makeRegistry(BonusTable.class, () -> new RegistryBuilder<BonusTable>().dataPackRegistry(BonusTable.CODEC));
    ...
    public static final Supplier<IForgeRegistry<TrinketSet>> TRINKET_SET_REGISTRY = TRINKET_SET_DEFERRED_REGISTER.makeRegistry(TrinketSet.class, () -> new RegistryBuilder<TrinketSet>().dataPackRegistry(TrinketSet.CODEC));
